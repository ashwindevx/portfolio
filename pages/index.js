          ...
          <div className="border-b-2 border-black flex justify-between">
            ...
            <div className=" w-full p-4 flex-[50%] border-r-2 border-black flex flex-col justify-between">
              ...
              <p className="font-body font-normal text-lg text-black leading-7">
                ...
                did my High schooling from MPS school, Meerut in Science. As my
                interest was in Coding hence I immediately after my high
                schooling I joined Devsnest Bootcamp for 7 months course and I
                started learning from free sources. Then started teaching myself
                to Code and Design. In early 2021 I joined Cato now Navgurukul
                Labs as a volunteer Front End Web Developer and Web Designer.
                After working a couple of months as a volunteer I joined as a
                full time developer there. So, it’s been a year and a half since
                working there.
              </p>
              <div className="bg-black w-full h-full mt-6 bg-[url('https://www.transparenttextures.com/patterns/mooning.png')]"></div>
            </div>
            {/* project section */}
